  ...
  return (
    <tr>
      ...
      <div style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'flex-end', flexDirection: 'column' }}>
          ...
          <span>Venta total: $ {(totalSellingPrice * exchangeRate).toFixed(0)}</span>
          <span>Costo total: $ {(productData.totalProductCost * exchangeRate).toFixed(0)}</span>
          <span>Utilidad: $ {(netUtitlitie * exchangeRate).toFixed(0)}</span>
